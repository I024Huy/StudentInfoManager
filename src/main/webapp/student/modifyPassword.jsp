        ...
        <div class="col-md-12">
            ...
            <form type="post">
                <div class="row">
                    ...
                    <div class="col-md-3"><input type="password" id="spassword" name="spassword" class="form-control"
...
<script>
	$("#btn").click(function () {
		...
		$.ajax({
			url:"${pageContext.request.contextPath}/StudentHandler/modifyPassword",
			type:"post",
			data:{"sid":${sessionScope.student.sid},"spassword":pwd},
			success:function (result) {
				if(result == 1){
					alert("修改成功，请重新登陆！");
					window.location.href="/StudentInfo/index.jsp";
				}else{
					window.location.href="/StudentInfo/fail.jsp"
				}
			},
            error:function(e){
                alert(e)
